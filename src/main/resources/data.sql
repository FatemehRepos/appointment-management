insert into appointment_type (id, title, disabled, creator_id, last_modifier_id)
values (1, 'ONLINE', 1, 1, 1),
       (2, 'IN_PERSON', 1, 1, 1),
       (3, 'CHAT', 1, 1, 1);

insert into appointment_status (id, title, disabled, creator_id, last_modifier_id)
values (1, 'SCHEDULED', 1, 1, 1),
       (2, 'IN_PERSON', 1, 1, 1),
       (3, 'DONE', 1, 1, 1),
       (4, 'CANCELED', 1, 1, 1);

insert into reservation_type (id, title, disabled, creator_id, last_modifier_id)
values (1, 'ONLINE',1, 1, 1),
       (2, 'BY_RECEPTIONIST',1, 1, 1);
